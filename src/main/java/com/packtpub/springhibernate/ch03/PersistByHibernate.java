...
public class PersistByHibernate {
	...
	public static void main(String[] args) {
		...
		ApplicationContext  ctx = new ClassPathXmlApplicationContext("com/packtpub/springhibernate/ch03/spring-context.xml");
		
		Student student = (Student) ctx.getBean("student");
		
		student.setId(41);
		student.setFirstName("Hamid2");
		student.setLastName("doosti2");
